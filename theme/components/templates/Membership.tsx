// import MembershipAllProductsGrid from '@components/common/MembershipAllProductsGrid'
        ...
        <div className="py-20 bg-gray-50 radius-for-skewed">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center mb-16">
              ...
              <h2 className="mb-2 text-4xl lg:text-5xl font-bold font-heading lg:leading-normal">
