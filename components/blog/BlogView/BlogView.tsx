...
import { Facebook, Instagram, Pinterest, Tiktok } from '@components/icons'
  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto">
        <Container className={'prose'} data-testid="BlogView">
          ...
          <div style={{ textAlign: 'left' }}>
            <strong>
              Where are you from, and how did you come to be living life as you
              know it?
              <br />
            </strong>
            Just outside Vancouver, Canada. I was born and raised here but as a
            teen spent time in Germany and Tanzania which changed my outlook on
            what life could look like for someone from my small town. My husband
            and I found out we were having a son when I was 20, so I quit my job
            working in an office to focus on my mental and physical health in
            preparation. When my son Isaac (now 7) was a few months old I began
            sewing and selling hair accessories…I did this for a few years and
            although it was a successful business, I found myself spending more
            time at vintage shops and decided to start from scratch and open
            Bohème Goods. I honestly thought I would sell 3 or 4 items a month
            and things would be slow again, but I was incredibly fortunate to
            have grown in a rather rapid but organic way.
            <span>&nbsp;</span>
            <strong>
              <br />
            </strong>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            of my mind. The things I love to surround myself with and the things
            I love to wear. It’s what has made running a business on my own such
            a rewarding journey.<span>&nbsp;</span>
            <strong>
              <br />
            </strong>
          </div>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            morning I turn on music and open all the windows to let the sunlight
            in before waking our boys.
            <br />
            <strong>
              <br />
            </strong>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            Old art books - with things having slowed down over the past months
            I’ve gotten time to really dig into our bookcase and re-read some of
            my favourite books.
            <br />
            <br />
          </div>
          <div style={{ textAlign: 'left' }}>
            ...
            here for 8 years we realize that it sets the mood every single day.
            <br />
            <br />
          </div>
          <div style={{ textAlign: 'left' }}>
